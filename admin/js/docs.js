var Docs = function(){
    ...
    return {
        init : function(){
            ...
            layout.add('east', new Ext.ContentPanel('classes', {title: 'Modules Explorer', fitToFrame:true}));

            layout.add('west', new Ext.ContentPanel('classes', {title: 'Modules Explorer', fitToFrame:true}));
