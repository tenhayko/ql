...
//---------------------------
    ...
    if ($pid) {
        ...
        $result = $db->sql_query("SELECT id,name,code_cv,sort_order,quyen from " . $prefix . "_chucvu where id='" . intval($pid) . "' order by sort_order asc ");
        ...
        $option="
        <option value='11'". ($quyen == 11 ? 'Selected' : '') .">Văn thư </option>
        <option value='1'". ($quyen == 1 ? 'Selected' : '') .">Chuyên viên  </option>
        <option value='22'". ($quyen == 22 ? 'Selected' : '') .">Chánh văn phòng </option>
        <option value='2'". ($quyen == 2 ? 'Selected' : '') .">Trưởng phòng </option>
        <option value='2'". ($quyen == 2 ? 'Selected' : '') .">Phó phòng  </option>
        <option value='3'". ($quyen == 3 ? 'Selected' : '') .">Phó chủ tịch </option>
        <option value='4'". ($quyen == 4 ? 'Selected' : '') .">Chủ tịch </option>
