...
$dbuname = "root";
$dbpass = "123";
$dbname = "qts_dsvh_tb_full";
$prefix = "portal";
$user_prefix = "portal";
$dbtype = "MySQL";
$sitekey = "v7FQW22gbESxEQ061NUMikqLmgbQLShvEUJp0kA2";
$gfx_chk = 0;
$subscription_url = "";
$admin_file = "admin";
$nuke_editor = 1;
...
$max_year=2012;
$company_code = 'TD';
define("_MAX_WIDTH_THUMBNAIL_IMAGE_SIZE","130");
define("_MAX_HEIGHT_THUMBNAIL_IMAGE_SIZE","100");
define("_MAX_WIDTH_IMAGE_SIZE","150");
define("_MAX_HEIGHT_IMAGE_SIZE","150");
define("_MAX_THUMB_WIDTH_IMAGE_SIZE","80");
define("_MAX_THUMB_HEIGHT_IMAGE_SIZE","60");
