...
function timkiem($page, $number_per_page){
	...
	var sonamct = $("#sonamct").val();
	var page = $page;
var number_per_page = $number_per_page;
	var strURL="admin.php?op=BC_thamniencongtac_Print&name_khaisinh="+name_khaisinh+"&phongban="+phongban+"&sonamct="+sonamct+"&page="+page+ "&number_per_page="+number_per_page;
		var req = getXMLHTTP();
