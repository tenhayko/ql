...
function timkiem($page, $number_per_page){
	...
	var sonamct = $("#hanhopdong").val();
	var page = $page;
var number_per_page = $number_per_page;
	var strURL="admin.php?op=BC_hethan_hopdong_Print&name_khaisinh="+name_khaisinh+"&phongban="+phongban+"&sonamct="+sonamct+"&page="+page+ "&number_per_page="+number_per_page;
		var req = getXMLHTTP();
