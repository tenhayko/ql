...
var number_per_page = $number_per_page;
	var strURL="admin.php?op=BC_congdoan_Print&name_khaisinh="+name_khaisinh+"&phongban="+phongban+"&date_picker="+date_picker+"&page="+page+ "&number_per_page="+number_per_page;
		var req = getXMLHTTP();
