...
var number_per_page = $number_per_page;
	var strURL="admin.php?op=BC_di_nuocngoai_Print&name_khaisinh="+name_khaisinh+"&date_picker="+date_picker+"&quocgia="+quocgia+"&page="+page+ "&number_per_page="+number_per_page;
		var req = getXMLHTTP();
