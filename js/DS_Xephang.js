...
var number_per_page = $number_per_page;
	var strURL="admin.php?op=Search_DS_Xephang&name_disan="+name_disan+"&tom_tat="+tom_tat+"&thoigiandienra="+thoigiandienra+"&hienvat_tb="+hienvat_tb+"&dientich_dat="+dientich_dat+"&dientich_xd="+dientich_xd+"&loai_ds="+loai_ds+"&huyen="+huyen+"&xaphuong="+xaphuong+"&hientrang="+hientrang+"&tenditich="+tenditich+"&pid="+pid+"&page="+page+ "&number_per_page="+number_per_page;
		var req = getXMLHTTP();
